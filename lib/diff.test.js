(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "diff-match-patch", "jsdom", "./diff", "./util"], factory);
    }
    ...
    function fragmentToHtml(documentFragment) {
        return Array.from(documentFragment.childNodes).reduce((html, node) => html +
            (util_1.isText(node) ? node.data : util_1.isElement(node) ? node.outerHTML : ''), '');
    }
    ...
    test.each([
        [
            'empty documents',
            new jsdom_1.JSDOM('').window.document,
            new jsdom_1.JSDOM('').window.document,
        ...
        [
            ...
            new jsdom_1.JSDOM('Hello').window.document,
            new jsdom_1.JSDOM('Hello').window.document,
        ...
        [
            ...
            new jsdom_1.JSDOM('Prefix Old Suffix').window.document,
            new jsdom_1.JSDOM('Prefix New Suffix').window.document,
        ...
        [
            ...
            (() => {
                ...
                fragment.append(document.createTextNode('He'), document.createTextNode(''), document.createTextNode('llo'), document.createTextNode(' World'));
                return fragment;
            })(),
            (() => {
                const fragment = document.createDocumentFragment();
                fragment.append(document.createTextNode('H'), document.createTextNode('ello W'), document.createTextNode('or'), document.createTextNode(''), document.createTextNode('ld'));
                return fragment;
            })(),
            'Hello World',
            undefined,
        ...
        [
            ...
            htmlToFragment('Prefix <strong><span style="color:red;">form<!-- force 2 text nodes -->atted</span></strong> Suffix'),
        ...
        [
            ...
            htmlToFragment('<p>This content is skipped</p><video><source></video><div><img>Hello</div>'),
            htmlToFragment('<p>Ignored too</p><video><source></video><div><img>Hello</div>'),
        ...
        [
            ...
            htmlToFragment('<a><strong>p as formatting</strong></a> <strong>em as structure</strong>'),
            htmlToFragment('<p><a>p as formatting</a></p> <em>em as structure</em>'),
        ...
        [
            ...
            htmlToFragment('<p>prefix <strong>modified</strong> old suffix removed</p><img src="image.png"><p data-value="old">test</p>'),
            htmlToFragment('<p>added prefix <em><u>modified</u></em> new suffix</p><img src="image.jpg"><p data-value="new">test</p>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table><table><tbody><tr><td>two</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><colgroup></colgroup><tbody><tr><td>one</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td>123456</td></tr></tbody></table>'),
            htmlToFragment('<table><caption>123456</caption><tbody><tr><td></td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><thead><tr></tr></thead><tbody><tr><td></td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td></td></tr></tbody><tfoot><tr></tr></tfoot></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><thead><tr><!-- a --></tr></thead><tbody><tr><td></td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td></td></tr></tbody><tfoot><tr><!-- a --></tr></tfoot></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td></td></tr><tr><td></td><td></td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td rowspan="2"></td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td colspan="2"></td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table>'),
            htmlToFragment('<table><thead></thead><tbody><tr><td colspan="1" rowspan="1">one</td></tr></tbody><tfoot></tfoot></table>'),
        ...
        [
            'table - add TD',
            htmlToFragment('<table><tbody><tr><td>one</td><td>two</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td><td>two</td><td>three</td></tr></tbody></table>'),
        ...
        [
            'table - add TH',
            htmlToFragment('<table><tbody><tr><td>one</td><td>two</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td><td>two</td><th>three</th></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td>one</td><td>two</td><td>three</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><th>one</th><td>two</td><td>three</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td>one</td><td>two</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>two</td><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><th>one</th><th>two</th></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><th>two</th><th>one</th></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><th>one</th><td>two</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><th>two</th><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><th>one</th><td>two</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>two</td><th>one</th></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td>one</td><td>two</td><td>three</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>two</td><td>one</td><td>three</td><td>four</td><td>five</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td>one</td><td>two</td><td>three</td><td>four</td><td>five</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>two</td><td>one</td><td>three</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td><strong>one</strong></td><td><strong>two</strong></td><td><strong>three</strong></td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td><i>two</i></td><td><i>one</i></td><td><i>three</i></td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><td>one</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><td>one</td></tr><tr><td>two</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><thead></thead><tbody><tr><td>one</td></tr></tbody></table>'),
            htmlToFragment('<table><thead><tr><td>zero</td></tr></thead><tbody><tr><td>one</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><th>first column</th><th>last column</th></tr><tr><td>4444</td><td>6666</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><th>first column</th><th>second column</th><th>last column</th></tr><tr><td>1111</td><td>2222</td><td>3333</td></tr><tr><td>4444</td><td>5555</td><td>6666</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><th>first column</th><th>second column</th><th>last column</th></tr><tr><td>4444</td><td>5555</td><td>6666</td></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><th>first column</th><th>last column</th></tr><tr><td>1111</td><td>3333</td></tr><tr><td>4444</td><td>6666</td></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><tbody><tr><th>first column</th><th>second column</th><th>last column</th></tr></tbody></table>'),
            htmlToFragment('<table><thead><tr><th>1111</th><th>3333</th></tr></thead><tbody><tr><th>first column</th><th>last column</th></tr></tbody></table>'),
        ...
        [
            ...
            htmlToFragment('<table><thead><tr><th>1111</th><th>2222</th><th>3333</th></tr></thead><tbody><tr><th>first column</th><th>second column</th><th>last column</th></tr></tbody></table>'),
            htmlToFragment('<table><tbody><tr><th>first column</th><th>last column</th></tr></tbody></table>'),
    ...
    ])('%s', (_message, oldNode, newNode, expectedHtml, options) => {
        const oldClone = oldNode.cloneNode(true);
        const newClone = newNode.cloneNode(true);
        const fragment = diff_1.visualDomDiff(oldNode, newNode, options);
        expect(fragment.nodeName).toBe('#document-fragment');
        expect(fragmentToHtml(fragment)).toBe(expectedHtml);
        expect(util_1.areNodesEqual(oldNode, oldClone, true)).toBe(true);
        expect(util_1.areNodesEqual(newNode, newClone, true)).toBe(true);
    });
});
