...
export function strictEqual(item1, item2) {
    return item1 === item2;
}
export function areArraysEqual(array1, array2, comparator = strictEqual) {
 ...
 */
export function areNodesEqual(node1, node2, deep = false) {
    if (node1 === node2) {
        return true;
    }
 ...
 */
export function getAncestors(node, rootNode = null) {
...
export function never(message = 'visual-dom-diff: Should never happen') {
 ...
 */
export function charForNodeName(nodeName) {
...
export function markUpNode(node, elementName, className) {
...
export function isTableValid(table, verifyColumns) {
    let columnCount;
